...
def measurementControl(linkMass, linkDimensions):
    ...
    print(
        ...
        "\n|-----------------------|-------------|---------------------|",
        "\n|base                 |",
        str(round(linkMass["base_mass"], 2)).ljust(11),
        "|",
        "x: ",
        str(round(linkDimensions["base"]["X"], 2)).ljust(15),
        "|",
        "\n|                       |",
        "            |",
        "y: ",
        str(round(linkDimensions["base"]["Y"], 2)).ljust(15),
        "|",
        "\n|                       |",
        "            |",
        "z: ",
        str(round(linkDimensions["base"]["Z"], 2)).ljust(15),
        "|",
        "\n|-----------------------|-------------|---------------------|",
        "\n|Shoulder               |",
